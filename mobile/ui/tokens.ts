// Design tokens for the mobile app (no web support)

export type ColorToken = 'bg' | 'surface' | 'text' | 'muted' | 'primary' | 'primaryText' | 'border';
...
export const fontWeights: Record<FontWeightToken, string | number> = {
  regular: '400',
  medium: '600',
  bold: '700',
};
